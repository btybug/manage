...
{!! HTML::style('public/libs/datatable/css/jquery.dataTables.min.css') !!}
{!! HTML::style('public/libs/datatable/css/dataTables.bootstrap.min.css') !!}
{!! HTML::style('public/libs/datatable/extensions/Buttons/css/buttons.dataTables.min.css') !!}
@endpush
@push('javascript')
{!! HTML::script('public/libs/datatable/js/jquery.dataTables.min.js') !!}
...
{!! HTML::script('public/libs/datatable/extensions/Select/js/dataTables.select.min.js') !!}
