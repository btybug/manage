	...
	<div class="container-fluid p-0 m-t-10">
		<div class="col-md-3 p-l-0">
			<div class="panel panel-default p-0">
				<div class="panel-heading bg-black-darker text-white">Email Groups<a data-toggle="collapse" href="#addnewGroup" class="btn btn-default btn-xs pull-right collapsed" aria-expanded="false"><i class="fa fa-plus" aria-hidden="true"></i></a>
				</div>
				<div class="panel-body">
					<div id="addnewGroup" class="posrelative collapse" aria-expanded="false" style="height: 0px;">
						...
						<div class="row">
							<div class="form-group col-xs-8 col-sm-8 p-0 p-r-5">
								<input class="form-control" placeholder="Add New Group" data-selector="newgroup" type="text">
							</div>
							<div class="form-group col-xs-4 col-sm-4 p-0">
								<button class="btn btn-primary btn-block p-l-0 p-r-0" type="button" data-action="saveNewGroup">save</button>
							</div>
						</div>
					</div>
					<ul class="list-group source listwithlink" data-role="grouplist">
						...
						<li class="{!! ($group->id==$id)?'active':'' !!} list-group-item" data-id="{!! $group->id !!}"><a href="{!! url('/admin/manage/emails',$group->id) !!}"> {!! $group->name !!} </a><span class="listtool"><a href="#" class="btn btn-default" data-action="editGroup" data-id="4" data-title="common"><i class="fa fa-pencil" aria-hidden="true"></i></a> <a href="#" class="btn btn-default" data-action="deleteGroup" data-id="4"><i class="fa fa-trash-o" aria-hidden="true"></i></a></span>
						</li>
							@endforeach
					</ul>
				</div>
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<div class="form-group">
			  ...
			  <div class="col-sm-10"> <input class="form-control emailName" data-inval="emailname" placeholder="Name" name="name" value="" type="text">
			</div>
		  </div>
       ...
       $('body').on('click', '.add-new-email', function(){
		...
		$('[data-action="saveNewGroup"]').click(function(e){
		  ...
		  $('body').on('click', '[data-btnrole="saveemail"]', function(e){
			   e.preventDefault()
			   var data= {'group_id': $('[data-role="grouplist"] li.active').data('id'), name: $('[data-inval="emailname"]').val()}
			   $('#addEmail').modal('hide')
