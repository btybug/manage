				  ...
				  <div class="">
					  <div class="radio">
						  <label class="radio_label">
							  {!! Form::radio('enable_registration', 1, (isset($system['enable_registration']) && $system['enable_registration']) ? 'checked' : '',['class' =>"enable_registration"]) !!} Yes
						  </label>
						  <label class="radio_label">
							  {!! Form::radio('enable_registration', 0, (!isset($system['enable_registration']) || ($system['enable_registration'] == 0) ) ? 'checked' : '',['class' =>"enable_registration"]) !!} No
						  </label>
					  </div>
				  </div>
			  </div>
			  ...
			  <div class="form-group">
			    {!! Form::label('browser_close','Session end on Browser close',['class' => 'control-label labels'])!!}
				  <div class="">
					    <div class="radio">
							<label class="radio_label">
								{!! Form::radio('browser_close', 1, (isset($system['browser_close']) && $system['browser_close']) ? 'checked' : '') !!} Yes
							</label>
							<label class="radio_label">
								{!! Form::radio('browser_close', 0, (!isset($system['browser_close']) || ($system['browser_close'] == 0) ) ? 'checked' : '') !!} No
							</label>
						</div>
				  </div>
			  </div>
