...
<div class="row toolbarNav m-b-10 p-b-5" >
  <div class="row">
    ...
    <div class="col-md-3 text-right"><a href="#"  class="btn btn-default btn-default-gray">Discard</a> {!! Form::submit('Save Menu', array('class' => 'btn btn-danger btn-danger-red')) !!} </div>
  </div>
</div>
<div class="row"> 
  ...
  <div class="col-md-4" >
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingPages">
          <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsePages" aria-expanded="true" aria-controls="collapsePages">Pages</a> </h4>
        </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingLink">
        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseLink" aria-expanded="true" aria-controls="collapseLink">Custom Link</a> </h4>
      </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingTexonomie">
        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTexonomie" aria-expanded="true" aria-controls="collapseTexonomie">Texonomie</a> </h4>
      </div>
...
<div class="col-md-8">
  <div class="panel panel-default">
    <div class="panel-heading bg-black-darker text-white"><a href="/admin/manage/frontend/menus/menufile/menu" class="btn btn-default btn-xs pull-right" data-download="json" download="menujson.json">Download</a> <a href="#" class="btn btn-default btn-xs pull-right m-r-10" data-preview="menu">Preview</a> Menu Item </div>
    <div class="panel-body">
